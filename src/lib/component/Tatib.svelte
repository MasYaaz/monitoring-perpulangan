...
<div class="flex min-h-screen max-w-4xl w-full flex-col items-center py-5 dark:text-white">
	<div class="flex w-full justify-center items-center lg:gap-5">
		<NotebookPen class="h-20 w-20 lg:h-25 lg:w-25 dark:text-white" />
		<h1
			class="text-center font-heading text-xl lg:w-100 lg:text-3xl font-bold uppercase dark:text-white"
		>
